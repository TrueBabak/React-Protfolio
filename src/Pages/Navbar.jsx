...
const Navbar = () => {
    ...
    return (
            <div className={navColour ? "w-full flex justify-between items-center py-2 fixed top-0 left-1/2 -translate-x-1/2 transition-all duration-200 ease-in-out z-50 backdrop-blur-sm bg-[#2323232c] shadow-xl" : "w-full flex justify-between items-center py-2 fixed top-0 left-1/2 z-50 -translate-x-1/2 transition-all duration-200"}>
